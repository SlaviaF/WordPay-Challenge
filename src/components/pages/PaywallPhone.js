    ...
    return (
        <div className="paywall-phone-container">
         <img src={boy} alt="boy in a playground with a ball" />
            ...
            <PaywallColoredLine color="rgba(238, 238, 238, 1)" width="172px" margin="28px"/>
            ...
            <PaywallColoredLine color="rgba(189, 215, 244, 1)" width="236px"  margin="14px"/>
            </div>
        <div className="paywall-btn-container">
            <Button radius="5px" color="white" fontWeight="500" letterSpacing="10%" lineHeight="20px" backgroundColor="black" margin="14px"> Buy article</Button>
